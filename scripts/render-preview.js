...
const TS_SAMPLE = [
  ...
  [['    ', null], ['let', 'storage.type'], [' ', null], ['raw', 'variable'], [';', 'punctuation']],
  [['    ', null], ['try', 'keyword.control.trycatch'], [' { ', 'punctuation'], ['raw', 'variable'],
   [' = ', 'keyword.operator'], ['await', 'keyword.control'], [' ', null], ['readFile', 'entity.name.function'],
   ['(', 'punctuation'], ['file', 'variable'], [', ', 'punctuation'], ['"utf8"', 'string.quoted'],
   ['); }', 'punctuation']],
  [['    ', null], ['catch', 'keyword.control.trycatch'], [' { ', 'punctuation'], ['return', 'keyword.control'],
   [' ', null], ['null', 'constant.language'], ['; }', 'punctuation']],
  [],
